  ...
  if (!code) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
        <div
          className="w-full max-w-md rounded-[30px] border-4 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.55)]"
          style={{
            borderColor: "#FFD700",
            background:
        ...
        >
          <div className="text-[28px] font-black italic uppercase tracking-tight text-white leading-none mb-2">
            Вход ребёнка
          </div>
          <div className="text-[12px] font-bold uppercase tracking-[0.11em] text-white/70 mb-4">
          ...
          <input
            ...
            className="w-full rounded-2xl px-4 py-4 text-[30px] font-black italic uppercase tracking-tight bg-black/70 text-white border-2 placeholder:text-white/35 focus:outline-none"
          ...
          <div className="text-[10px] font-bold uppercase tracking-[0.08em] text-white/45 mt-4">
